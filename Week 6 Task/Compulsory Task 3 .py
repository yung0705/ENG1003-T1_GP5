...
class AStarPlanner:
    ...
    def __init__(self, ox, oy, resolution, rr, fc_x, fc_y, tc_x, tc_y , minus_cost_x , minus_cost_y):
        """
        ...
        self.minus_cost_x = minus_cost_x
        self.minus_cost_y = minus_cost_y
        ...
        print("PolyU-Group5 cost part1-> ", self.C_F * (self.Delta_F + self.Delta_F_A) )
        print("PolyU-Group5 cost part2-> ", self.C_T * (self.Delta_T + self.Delta_T_A) )
        print("PolyU-Group5 cost part3-> ", self.C_C )
...
def main():
    ...
    a_star = AStarPlanner(ox, oy, grid_size, robot_radius, fc_x, fc_y, tc_x, tc_y, minus_cost_x, minus_cost_y)
