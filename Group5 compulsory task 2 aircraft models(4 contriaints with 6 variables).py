...
class AStarPlanner:
    ...
    def __init__(self, ox, oy, resolution, rr, fc_x, fc_y, tc_x, tc_y):
        ...
        print("PolyU-Group5 A380 cost part1-> ", self.C_F * (self.Delta_F + self.Delta_F_A) )
        print("PolyU-Group5 A380 cost part2-> ", self.C_T * (self.Delta_T + self.Delta_T_A) )
        print("PolyU-Group5 A380 cost part3-> ", self.C_C )
